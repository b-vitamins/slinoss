...
| Walker bracketed arithmetic, two layers | one full 100k cell | 97.03 min | Automation | The first attempt was externally terminated; the uninterrupted second attempt exhausted the full budget. |
