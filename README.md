...
```txt
slinoss @ https://github.com/b-vitamins/slinoss/releases/download/v0.5.1/slinoss-0.5.1-py3-none-any.whl
```
...
```txt
slinoss[cuda] @ https://github.com/b-vitamins/slinoss/releases/download/v0.5.1/slinoss-0.5.1-cp311-cp311-linux_x86_64.whl
```
...
Replace `v0.5.1` and `0.5.1` with the release tag and package version you want
