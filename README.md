...
```txt
slinoss @ https://github.com/b-vitamins/slinoss/releases/download/v0.5.0/slinoss-0.5.0-py3-none-any.whl
```
...
```txt
slinoss[cuda] @ https://github.com/b-vitamins/slinoss/releases/download/v0.5.0/slinoss-0.5.0-cp311-cp311-linux_x86_64.whl
```
...
Replace `v0.5.0` and `0.5.0` with the release tag and package version you want
